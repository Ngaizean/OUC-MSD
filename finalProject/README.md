...
"海大拼车"是中国海洋大学校园内的一款拼车服务小程序，旨在为师生提供便捷的拼车出行解决方案。本项目采用微信云开发架构，整合了数据库、云函数和云存储三大基础能力，实现了用户发布拼车信息、在线报名、实时拼车等核心功能。
...
- 博客：[y_y_z_y_y_z](https://blog.csdn.net/y_y_z_y_y_z?spm=1000.2115.3001.5343)
